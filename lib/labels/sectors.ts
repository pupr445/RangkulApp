...
export const SECTOR_LABELS: Record<SectorKey, LabelSet> = {
  sekolah: {
    ...
    statusLabels: { todo: "Diberikan", doing: "Dikerjakan", done: "Selesai" },
    workflowStages: [
  ...
  klinik: {
    ...
    statusLabels: { todo: "Terjadwal", doing: "Pemeriksaan", done: "Selesai" },
    workflowStages: [
  ...
  bisnis: {
    ...
    statusLabels: { todo: "Lead", doing: "Follow Up", done: "Selesai" },
    workflowStages: [
      { key: "lead", label: "Lead" },
  ...
  masjid: {
    ...
    statusLabels: { todo: "Direncanakan", doing: "Persiapan", done: "Selesai" },
    workflowStages: [
